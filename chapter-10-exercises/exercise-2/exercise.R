...
salaries$salary_up <- salaries$salaries_2018 > salaries$salaries_2017
...
nrow(salaries[ salaries$salary_up == TRUE, ])
...
average_sal_change <- salaries$adjustments
mean(average_sal_change)

# For people who did not get a raise, how much money did they lose on average?
no_raise <- salaries[salaries$salary_up == FALSE, "adjustments" ]
mean(no_raise)
